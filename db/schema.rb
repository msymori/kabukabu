...
ActiveRecord::Schema.define(version: 2020_03_22_025003) do

  create_table "campanies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "campany"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_campanies_on_user_id"
  end
  ...
  create_table "financials", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campany_id"], name: "index_financials_on_campany_id"
  end
  ...
  add_foreign_key "campanies", "users"
  add_foreign_key "financials", "campanies"
end
